...
#define LOG_DEBUG(fmt, ...) if (getenv("LAB1DEBUG") && atoi(getenv("LAB1DEBUG")) == 1 && logger_isEnabled(LogLevel_DEBUG)) { logger_log(LogLevel_DEBUG, __FILE__, __LINE__, fmt, ##__VA_ARGS__); }
